...
--update-target-interval=2500 --n-tot=781250 --checkpoint-interval=5000 \
...
CUDA_VISIBLE_DEVICES=0, python $loc/main.py --multiplay --identifier=$identifier --resume=$resume --load-last-model --game=$game --actor-index=5 $args $aux &
...
CUDA_VISIBLE_DEVICES=2, python $loc/main.py --multiplay --identifier=$identifier --resume=$resume --load-last-model --game=$game --actor-index=9 $args $aux --eval-stm &
...
CUDA_VISIBLE_DEVICES=0, python $loc/main.py --multiplay --identifier=$identifier --resume=$resume --load-last-model --game=$game --actor-index=11 $args $aux &
...
CUDA_VISIBLE_DEVICES=3, python $loc/main.py --evaluate --identifier=$identifier --resume=$resume --load-last-model --game=$game --play-episodes-interval=16 --wait=150 --epsilon=0.00164  $args $tensor $aux &
CUDA_VISIBLE_DEVICES=3, python $loc/main.py --evaluate --identifier=$identifier --resume=$resume --load-last-model --game=$game --play-episodes-interval=16 --epsilon=0.00164  $args $tensor $aux &
# CUDA_VISIBLE_DEVICES=0, python $loc/main.py --evaluate --identifier=$identifier --resume=$resume --load-last-model --game=$game --play-episodes-interval=16 --wait=150 --epsilon=0.00164  $args $tensor $aux --eval-stm &