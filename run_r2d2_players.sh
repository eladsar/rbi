...
--hidden-features=128 --hidden-features-rnn=512 --clip=1 --discount=0.99 \
--termination-reward=-1 --friction-reward=0 --priority-alpha=0.9 --priority-beta=0.6 --epsilon-a=0.001 \
